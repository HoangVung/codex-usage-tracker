...
def dashboard_payload(
    ...
    return {
        **dashboard_i18n_payload(language),
        ...
        "parser_scanned_files": _safe_int(metadata.get("scanned_files", 0)),
        "parser_parsed_events": _safe_int(metadata.get("parsed_events", 0)),
        "parser_skipped_events": _safe_int(metadata.get("skipped_events", 0)),
        "parser_unknown_types": metadata.get("parser_unknown_types", ""),
